...
target = """const EVIDENCE_BUCKET = '/derek_original_chat.txt.pdf';

const SOURCE_REGISTRY: Record<string, {label: string, meaning: string, url?: string}> = {
  'WA':
    { label:'WA-####', meaning:'WhatsApp chat export — message ID in the captured log (Nov 5 2025 – Feb 16 2026).', url:EVIDENCE_BUCKET },
  'SC':
  ...
  'GA':
    { label:'GA — GHOST ANALYSIS', meaning:'Independent AI forensic audit of the original chat export — NODE_771, GHOST_FRAGMENT v2.6. Source file pending upload.', url:EVIDENCE_BUCKET },
  'TESTIMONY': { label:'TESTIMONY', meaning:'First-person account of the Operative — events from the era the log does not recover.' }
};"""

replacement = """const EVIDENCE_BUCKET = 'https://console.cloud.google.com/storage/browser/astraltrash_other/derek?project=gen-lang-client-0646349261&pageState=(%22StorageObjectListTable%22:(%22f%22:%22%255B%255D%22))';
